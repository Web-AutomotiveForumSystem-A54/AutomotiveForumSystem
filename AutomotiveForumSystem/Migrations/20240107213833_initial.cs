    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "Step by step tutorial.", new DateTime(2024, 1, 7, 23, 38, 32, 893, DateTimeKind.Local).AddTicks(6081), false, 0, "I got my supra 1200 HP. Here is how i did that...", 1 });

            migrationBuilder.InsertData(
                table: "Comments",
                columns: new[] { "Id", "CommentId", "Content", "CreateDate", "IsDeleted", "PostID", "UserID" },
                values: new object[] { 1, null, "Awesome. I will follow your tutorial to tune my supra.", new DateTime(2024, 1, 7, 23, 38, 32, 893, DateTimeKind.Local).AddTicks(6141), false, 1, 1 });
